...
export const CalendarWeekIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 3.75h15A2.25 2.25 0 0 1 21.75 6v12a2.25 2.25 0 0 1-2.25 2.25H4.5A2.25 2.25 0 0 1 2.25 18V6A2.25 2.25 0 0 1 4.5 3.75Z" />
...
export const ArrowPathIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001a.75.75 0 0 1 .75.75c0 .414-.336.75-.75.75h-4.992a2.25 2.25 0 0 1-2.25-2.25V6.108a.75.75 0 0 1 1.5 0v1.99a.75.75 0 0 0 .75.75h.001ZM3.75 12a8.25 8.25 0 0 1 8.25-8.25v.001a.75.75 0 0 1 1.5 0v-.001a9.75 9.75 0 0 0-9.75 9.75c0 1.052.174 2.072.5 3.022a.75.75 0 0 1-.624.962l-1.54-.256a.75.75 0 0 1-.624-.962A8.25 8.25 0 0 1 3.75 12Z" />
  </svg>
);
...
export const ScaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52v16.5m-1.25-16.5v16.5m-1.25-16.5v16.5m-1.25-16.5v16.5m-1.25-16.5v16.5m-9-16.5c-1.01.143-2.01.317-3 .52m3-.52v16.5m-1.25-16.5v16.5m-1.25-16.5v16.5m-1.25-16.5v16.5m-1.25-16.5v16.5M5.25 6.37A48.416 48.416 0 0 1 12 6c2.291 0 4.545.16 6.75.47m13.5 0V21" />
  </svg>
);
...
export const RunningIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 0 1-1.161.886l-.143.048a1.107 1.107 0 0 0-.57 1.664c.369.555.169 1.307-.427 1.605L9 13.125l.423 1.059a.956.956 0 0 1-1.652.928l-.679-.906a1.125 1.125 0 0 0-1.906.172L4.5 15.75l-.612.153M12.75 3.031a9 9 0 0 0-8.862 12.872M12.75 3.031a9 9 0 0 1 6.69 14.036m0 0-.177.177a.938.938 0 0 0-1.326 0l-3.178-3.178a.938.938 0 0 0-1.326 0l-1.263 1.263a.938.938 0 0 0 0 1.326l3.178 3.178a.938.938 0 0 0 1.326 0l.177-.177.177.177a.938.938 0 0 0 1.326 0l3.178-3.178a.938.938 0 0 0 0-1.326l-1.263-1.263a.938.938 0 0 0-1.326 0Z" />
    </svg>
);

export const CogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.002 1.118-1.217l.443-.178a2 2 0 0 1 2.185.348l.22.219c.44.432.99.736 1.583.899l.491.13a2 2 0 0 1 1.503 1.936v.041c0 .64.307 1.226.83 1.618l.338.253a2 2 0 0 1 .374 2.454l-.14.269a3.5 3.5 0 0 0-.05 5.22l.14.27a2 2 0 0 1-.373 2.454l-.338.253c-.524.392-.83.978-.83 1.618v.041a2 2 0 0 1-1.503 1.936l-.491.13a4.5 4.5 0 0 1-1.583.899l-.22.219a2 2 0 0 1-2.185-.348l-.443-.178c-.558-.215-1.028-.675-1.118-1.217l-.09-.542a4.5 4.5 0 0 0-5.18 0l-.09.542c-.09.542-.56 1.002-1.118 1.217l-.443.178a2 2 0 0 1-2.185-.348l-.22-.219a4.5 4.5 0 0 1-1.583-.899l-.491-.13a2 2 0 0 1-1.503-1.936v-.041c0-.64-.307-1.226-.83-1.618l-.338-.253a2 2 0 0 1-.374-2.454l.14-.269a3.5 3.5 0 0 0 .05-5.22l-.14-.27a2 2 0 0 1 .373-2.454l.338-.253c.524-.392.83.978.83-1.618v-.041a2 2 0 0 1 1.503-1.936l.491-.13a4.5 4.5 0 0 1 1.583-.899l.22-.219a2 2 0 0 1 2.185-.348l.443.178c.558.215 1.028.675 1.118 1.217l.09.542a4.5 4.5 0 0 0 5.18 0zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
    </svg>
);
